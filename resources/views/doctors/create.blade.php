    ...
    <div class="col-12 col-lg-8">
        <div class="card p-4 shadow-sm border-0">
            <div class="d-flex align-items-center gap-3 mb-4">
                ...
                <h5 class="fw-bold mb-0 text-primary">{{ __('messages.add_doctor') }}</h5>
            </div>
            ...
            <form action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="specialization" id="specialization" class="form-control @error('specialization') is-invalid @enderror" value="{{ old('specialization') }}" required placeholder="{{ __('messages.specialization_placeholder') }}">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary px-4">{{ __('messages.save_doctor') }}</button>
                </div>
            </form>
        </div>
    </div>
